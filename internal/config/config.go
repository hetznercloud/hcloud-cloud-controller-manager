...
const (
	...
	robotProvidedNodeIpInternal = "ROBOT_PROVIDED_NODE_IP_INTERNAL"
...
func Read() (HCCMConfiguration, error) {
	...
	cfg.Robot.ProvidedNodeIpInternal, err = getEnvBool(robotProvidedNodeIpInternal, false)
	if err != nil {
		errs = append(errs, err)
	}
